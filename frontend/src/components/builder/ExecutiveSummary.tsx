                ...
                {data.assertions.map((assertion, index) => (
                    ...
                    >
                        ...
                        <div className="flex items-center gap-2 flex-wrap">
                            <div className={`px-3 py-1 rounded-full text-xs font-medium border ${getConfidenceBadgeColor(assertion.evidence.assumption_confidence)}`}>
                                {assertion.evidence.assumption_confidence} Confidence
                            </div>
                                    ...
                                    <div className="space-y-2 flex-1">
                                        <div>
                                            ...
                                            <div className="text-sm text-gray-300">
                                                {assertion.evidence.data_source}
                                            </div>
                                        </div>
