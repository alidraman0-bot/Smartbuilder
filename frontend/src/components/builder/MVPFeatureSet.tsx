            ...
            <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-2 px-4 py-2 rounded-lg bg-[#18181b] border border-[#27272a]">
                    ...
                    <span className="text-sm font-medium text-gray-400">
                        {data.features.length} Features Defined
                    </span>
                </div>
            </div>
                ...
                {data.features.map((feature, index) => (
                    ...
                    >
                        ...
                        <div className="flex items-start justify-between mb-3">
                            ...
                            <div className={`px-3 py-1 rounded-full text-[10px] font-black tracking-tighter border ${getPriorityColor(feature.priority)}`}>
                                {feature.priority}
                            </div>
                        </div>
                                ...
                                <div className="flex items-center gap-2">
                                    <div className="flex-1 h-1.5 bg-zinc-800 rounded-full overflow-hidden">
                                        <div
                                            ...
                                            style={{ width: `${feature.build_complexity * 10}%` }}
                                        />
                                    </div>
                                    <span className="text-sm font-bold text-white">{feature.build_complexity}/10</span>
                                </div>
                            </div>
