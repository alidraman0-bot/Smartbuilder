...
import { Mail, Lock, Eye, EyeOff, Loader2, Shield, CheckCircle, RotateCcw } from 'lucide-react';
...
export default function LoginPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        // Deliberate delay as per spec (300-500ms feel)
        setTimeout(() => {
            // Simulated login failure for demonstration or success
